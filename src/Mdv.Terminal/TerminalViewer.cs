...
public sealed class TerminalViewerOptions
{
    ...
    /// <summary>
    /// When true, mdv paints a solid background behind the document (overriding terminal
...
public sealed partial class TerminalViewer : IAsyncDisposable
{
    ...
    private readonly Mdv.Diagrams.ImageLoader _imageLoader;
    ...
    public TerminalViewer(TerminalViewerOptions options, IDiagramRenderer diagrams)
    {
        ...
        _imageLoader = new Mdv.Diagrams.ImageLoader(root);
